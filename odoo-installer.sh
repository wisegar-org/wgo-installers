...
./postgres/postgres-ubuntu-installer.sh $PG_PASSWORD $ODOO_USER $ODOO_DB_PASSWORD
./odoo/odoo-ubuntu-installer.sh $ODOO_USER $ODOO_DB_NAME $ODOO_DB_PASSWORD $ODOO_PORT
./caddy/caddy-ubuntu-installer.sh $ODOO_URL
